...
import { ThemeContext } from "./ThemeContext"; // Contexto de tema
...
export default function PrincipalScreen() {
  ...
  // Color de botón activo en el grid
  const colorBotonGrid = (pantalla) => (route.name === pantalla ? colors.naranja : colors.verde);
      ...
      <View style={[estilos.encabezado, { backgroundColor: colors.verde }]}>
        ...
        <View style={[estilos.saldoTarjeta, { backgroundColor: colors.tarjeta }]}>
          <TouchableOpacity onPress={() => handleNavegar("Perfil")}>
            <Text style={{ fontSize: 24, color: route.name === "Perfil" ? colors.naranja : colors.texto }}>🏦</Text>
          </TouchableOpacity>
      ...
      <View style={estilos.cuerpo}>
        <View style={[estilos.cajaBlanca, { backgroundColor: colors.tarjeta }]}>
          <View style={estilos.gridOpciones}>
            <TouchableOpacity
              style={[estilos.botonOpcion, { backgroundColor: colorBotonGrid("Perfil") }]}
            ...
            <TouchableOpacity
              style={[estilos.botonOpcion, { backgroundColor: colorBotonGrid("Registros") }]}
            ...
            <TouchableOpacity
              style={[estilos.botonOpcion, { backgroundColor: colorBotonGrid("Graficas") }]}
...
const estilos = StyleSheet.create({
  ...
  saldoTarjeta: { borderRadius: 16, padding: 16, flexDirection: "row", alignItems: "center" },
  ...
  cajaBlanca: { flex: 1, borderRadius: 16, padding: 20, alignItems: "center", justifyContent: "center" },
  gridOpciones: { width: "100%", maxWidth: 400, flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between" },
  botonOpcion: { width: "48%", aspectRatio: 1, borderRadius: 16, justifyContent: "center", alignItems: "center", marginBottom: 14, elevation: 3 },
  textoOpcion: { color: "white", textAlign: "center", fontWeight: "700", fontSize: 13, marginTop: 8 },
  botonTema: { margin: 16, padding: 12, borderRadius: 12, alignItems: "center" },
});
