...
// 2. Crear una instancia única del controlador (Asegúrate de que la ruta sea correcta)
const usuarioController = new UsuarioController();

// Componente para renderizar cada usuario en la lista
...
export default function InsertUsuarioScreen() {
    ...
    const handleCrearUsuario = async () => {
        ...
        try {
            ...
            // NOTA: No necesitamos llamar a cargarUsuarios() aquí
            // El controlador llamará a notifyListeners(), que activará
            // el observerCallback en useEffect y recargará la lista automáticamente.
    ...
    useEffect(() => {
        // 1. Callback del Observador
        const observerCallback = () => {
            console.log("NOTIFICACIÓN RECIBIDA: El controlador forzará la recarga de la lista.");
            cargarUsuarios(); // Se llama a la función de recarga cuando hay un cambio
        };
        ...
        // 3. Función de cleanup (Desuscripción al desmontar)
        return () => {
            usuarioController.removeListener(observerCallback);
        };
    }, [cargarUsuarios]); // Dependencia: cargarUsuarios (aunque es useCallback)
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.insertSection}>
                ...
                <TouchableOpacity 
                    // 4. Conectar la función de inserción
            ...
            <View style={styles.selectSection}>
                <View style={styles.selectHeader}>
                    ...
                    {/* 5. Conectar la función de recarga manual */}
                    <TouchableOpacity 
                        style={styles.refreshButton}
                        onPress={cargarUsuarios}
                        disabled={loading} >
                        <Text style={styles.refreshText}>{loading ? 'Cargando...' : 'Recargar'}</Text>
                    </TouchableOpacity>
                ...
                {loading ? (
                    ...
                    <FlatList
                        // 6. Conectar los datos y el renderizado
                        data={usuarios}
